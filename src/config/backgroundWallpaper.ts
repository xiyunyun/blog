...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/W1.png",
			"assets/images/DesktopWallpaper/W2.png",
			"assets/images/DesktopWallpaper/W3.png",
			"assets/images/DesktopWallpaper/W4.png",
			"assets/images/DesktopWallpaper/W5.png",
	...
	common: {
		...
		homeText: {
			...
			subtitle: [
				...
				"Not because the destination is certain",
				"But because the soul commands us to journey again",
			],
			// 主页横幅副标题字体大小
			subtitleSize: "1.5rem",
			typewriter: {
